...
<body>
  ...
  //function Page($PageID,$Back){
      ...
      <!-- Header -->
      <div class="main-head">
          <button class="icon-back fadeInDown w3-padding" onclick="Elearn.Back(this)"><i class="mbri-left w3-xlarge animate-slow animate-fill-back"></i></button>
          ...
          <div class="cont-bx">
              <div class=" smallLineHeight w3-xlarge animate-fill-back animate-delay-0-5 fadeInUp">TOWER OF IVORY</div>
...
?>
    <div class="w3-display-container nuco-container" id="nuco-main-cont">
      <div class="home w3-display-middle w3-center nuco-page" id="HomePage">
        ...
        <img src="images/logo.png" alt="AKS Logo" style="width:180px">
        </div>
        <div class="w3-xlarge w3-opacity fadeInDown animate-slow animate-fill-back">Welcome</div>
        <div class="w3-xxlarge nuco-name animate-fill-both fadeInDown animate-slow animate-delay-0-5">AKWA IBOM SCHOOLS</div>
        <div class="w3-large nuco-elearn w3-opacity-min fadeInUp animate-delay-1-5 animate-fill-back">dakkada Classroom</div>
